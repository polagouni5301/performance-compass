...
export const pipCases = [
  {
    ...
    endDate: "2026-04-30",
    duration: 60,
    triggerReason: "Test Case - 4th Cycle Success Track",
    ...
    reviews: [
      { number: 1, date: "2026-03-15", status: "met", kpiScore: 95, feedback: "Great start." },
      { number: 2, date: "2026-03-30", status: "met", kpiScore: 92, feedback: "Keep it up." },
      { number: 3, date: "2026-04-14", status: "met", kpiScore: 94, feedback: "Consistent." },
      { number: 4, date: "2026-04-29", status: "scheduled" },
    ],
    documentVersion: 4,
    extended: false,
    acknowledgedAt: "2026-03-02",
  ...
  },
  {
    ...
    targets: ["QA ≥ 90%", "AHT ≤ 7:00"],
    reviews: [
      { number: 1, date: "2026-03-15", status: "not-met", kpiScore: 85, feedback: "Needs focus." },
      { number: 2, date: "2026-03-30", status: "not-met", kpiScore: 82, feedback: "Declining." },
      { number: 3, date: "2026-04-14", status: "not-met", kpiScore: 84, feedback: "Still missing targets." },
      { number: 4, date: "2026-04-29", status: "scheduled" },
    ],
    documentVersion: 4,
    extended: false,
