                ...
                <tr key={c.employee.ohrId} className="hover:bg-secondary/40">
                  ...
                  <td className="py-3 pr-3 text-right">
                    <div className="flex justify-end gap-1.5">
                      ...
                      <Button size="sm" onClick={() => setDrawerFor(c.employee.ohrId)}>
        ...
        >
          ...
          >
            ...
            <p className="text-xs text-muted-foreground">
              {drawer.employee.ohrId} · {drawer.employee.team}
            </p>
            ...
            <div className="mt-6 flex flex-col gap-2">
              <Button asChild>
                <Link to="/supervisor/pip/initiate">
                  Proceed to initiation <ArrowRight className="ml-1 h-3.5 w-3.5" />
                </Link>
              </Button>
