          ...
          <SectionCard title="1 · Duration & basics">
            <div className="grid gap-4 md:grid-cols-2">
              <label className="block">
                ...
                <input
                  value="Aarav Mehta — OHR-204871"
                  disabled
                  className="mt-1.5 w-full rounded-xl border border-input bg-secondary/60 px-3 py-2.5 text-sm"
                />
              </label>
              <label className="block">
                ...
                <input
                  value="60 days"
                  disabled
                  className="mt-1.5 w-full rounded-xl border border-input bg-secondary/60 px-3 py-2.5 text-sm font-semibold"
                />
              </label>
            </div>
          </SectionCard>
            ...
            <div className="rounded-xl border border-primary/30 bg-primary-soft/40 p-4">
              ...
              <ul className="mt-3 space-y-1.5 text-xs">
                <li className="flex justify-between">
                  ...
                  <span className="font-medium">Fri, 8 May · 10:30 AM</span>
                </li>
                <li className="flex justify-between">
              ...
              <Button size="sm" variant="outline" className="mt-3 w-full">
                <Calendar className="mr-1 h-3.5 w-3.5" /> Reschedule
              </Button>
            </div>
          </SectionCard>
          ...
          <SectionCard title="On submit">
            <ul className="space-y-2 text-xs text-muted-foreground">
              <li className="flex items-start gap-2">
                <FileText className="mt-0.5 h-3.5 w-3.5 text-primary" /> PIP Word document generated
                (regular template)
              </li>
              <li className="flex items-start gap-2">
                <FileText className="mt-0.5 h-3.5 w-3.5 text-primary" /> 4 reviews scheduled at
                15-day intervals
              </li>
              <li className="flex items-start gap-2">
                <FileText className="mt-0.5 h-3.5 w-3.5 text-primary" /> Email sent to agent (CC
                manager); .eml acknowledgement captured
              </li>
            </ul>
          </SectionCard>
