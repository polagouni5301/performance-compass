  ...
  return (
    <div>
        ...
        <SectionCard>
          <div className="flex items-center gap-2">
            ...
            <StatusBadge variant="danger">
              <AlertTriangle className="h-3 w-3" /> HR escalation
            </StatusBadge>
          </div>
          <p className="mt-2 text-sm font-semibold">Repeat misconduct</p>
          <p className="text-xs text-muted-foreground">
            Termination path. HR-managed outside this tool.
          </p>
        </SectionCard>
      </div>
      ...
      <SectionCard
        ...
        className="mt-6"
        description="Driven by past warnings and same-breach history."
      >
          ...
          {samples.map(({ case: c, history, recommended }) => (
            <li key={c.id} className="grid gap-3 py-4 first:pt-0 last:pb-0 md:grid-cols-4">
              ...
              <div className="text-sm">
                ...
                <div className="font-medium">{c.breachType}</div>
              </div>
              <div className="text-sm">
                <span className="text-muted-foreground">Past CAPs</span>
