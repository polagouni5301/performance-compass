...
const IconBell = (p) => (
  <I {...p} d="M6 8a6 6 0 1 1 12 0c0 7 3 7 3 9H3c0-2 3-2 3-9Zm4 13a2 2 0 0 0 4 0" />
);
...
const tagStyles = {
  ...
  analytics:
    "bg-[oklch(0.95_0.06_305)] text-[oklch(0.5_0.18_305)] border-[oklch(0.55_0.18_305)]/25",
  ...
  const tools = [
    {
      ...
      tags: [
        { label: "Engine", tone: "engine" },
        { label: "Simulation", tone: "simulation" },
        { label: "Data Processing", tone: "data" },
      ],
      status: "Active",
      last: "2 minutes ago",
      icon: IconChart,
    ...
    },
    {
      ...
      tags: [
        ...
        { label: "Scheduling", tone: "scheduling" },
      ],
      status: "Configured",
      last: "1 hour ago",
      icon: IconLayers,
    ...
    },
    {
      ...
      tags: [
        { label: "Automation", tone: "automation" },
        { label: "Scheduling", tone: "scheduling" },
    ...
    },
    {
      ...
      tags: [
        ...
        { label: "Scoring", tone: "scoring" },
        { label: "Forecasting", tone: "forecasting" },
      ],
      status: "Active",
      last: "Today, 09:14",
      icon: IconBolt,
    ...
    },
    {
      ...
      tags: [
        { label: "Governance", tone: "governance" },
        { label: "Workflow", tone: "workflow" },
      ...
      <header className="sticky top-0 z-30 border-b border-border/60 bg-background/75 backdrop-blur-xl">
        <div className="mx-auto flex max-w-[1400px] items-center justify-between gap-4 px-6 py-3.5">
          ...
          <div className="hidden items-center gap-2 rounded-xl border border-border bg-background px-3 py-2 text-xs text-muted-foreground shadow-soft md:flex">
            ...
            <kbd className="ml-2 rounded bg-secondary px-1.5 py-0.5 font-mono text-[10px] text-foreground/60">
              ⌘K
            </kbd>
          </div>
        ...
        <div className="mb-5 flex items-end justify-between">
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              Five integrated engines · click to enter the workspace
            </p>
          </div>
          <div className="hidden gap-1 rounded-lg border border-border bg-card p-1 text-xs shadow-soft md:flex">
            <button className="rounded-md bg-foreground px-3 py-1 font-medium text-background">
              All
            </button>
            <button className="rounded-md px-3 py-1 text-muted-foreground hover:text-foreground">
              Engines
            </button>
            <button className="rounded-md px-3 py-1 text-muted-foreground hover:text-foreground">
              Workflows
            ...
            >
              ...
              <div className="relative">
                <div className="mb-4 flex items-start justify-between">
                  ...
                  <span
                    className={`inline-flex items-center gap-1.5 rounded-full border px-2.5 py-1 text-[10px] font-semibold ${statusStyles[t.status]}`}
                  >
                ...
                <div className="mt-4 flex flex-wrap gap-1.5">
                  {t.tags.map((tag) => (
                    <span
                      key={tag.label}
                      className={`rounded-md border px-2 py-0.5 text-[10px] font-semibold ${tagStyles[tag.tone]}`}
                    >
                      {tag.label}
                    </span>
                  ))}
